/*! This file is auto-generated */ ! function(t, e) {
    ...
    return o = {}, r.m = n = [function(t, e) {
        ...
        t.exports = function(t, e, n) {
            ...
            if (u.nodeList(t)) return o = t, r = e, i = n, Array.prototype.forEach.call(o, function(t) {
        ...
        var l = (function(t, e, n) {
                ...
                value: function() {
                    ...
                    this.fakeElem.style.top = e + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, this.container.appendChild(this.fakeElem), this.selectedText = r()(this.fakeElem), this.copyText()
                }
            }, {
                key: "removeFake",
                value: function() {
                ...
                key: "action",
                set: function() {
                    if (this._action = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "copy", "copy" !== this._action && "cut" !== this._action) throw new Error('Invalid "action" value, use either "copy" or "cut"')
                },
                get: function() {
                    return this._action
                }
